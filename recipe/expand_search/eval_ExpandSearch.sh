...
TOOL_CONFIG="$CONFIG_PATH/tools/search_tool_with_squeezer_config.yaml"
REWARD_FUNCTION_PATH="$PROJECT_DIR/ferret/reward_score"

BASE_MODEL="TreezzZ/Ferret_ExpandSearch_Qwen2.5-3b-instruct_Llama4-Maverick-17b-128e-instruct_ppo"
PROJECT_NAME="ferret"
EXPERIMENT_NAME="expand-search_qwen2.5-3b-instruct-ppo"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="$DATA_DIR/expand_search_train.parquet" \
    data.val_files="$DATA_DIR/expand_search_test.parquet"  \
