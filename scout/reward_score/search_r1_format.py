...
def compute_score_em(solution_str, ground_truth, data_source, extra_info, structure_format_score=0, final_format_score=0, retrieval_score=0, format_score=0, score=1.):
